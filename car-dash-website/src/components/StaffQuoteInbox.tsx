...
const input = "w-full rounded-2xl border border-white/10 bg-black/40 px-4 py-3 outline-none focus:border-[#FF2D2D]/55";
    ...
    <main className="min-h-screen bg-[#070707] px-5 py-8 text-white">
      <div className="mx-auto max-w-[1500px]">
        <div className="flex justify-between gap-4">
          <div>
            <p className="text-xs uppercase tracking-[.28em] text-[#FF2D2D]">Sales inbox</p>
                ...
                <div>
                  ...
                  <div className="space-y-3 py-5">
                    {active.messages.map((message) => {
                      ...
                      return (
                        <div key={message.id} className={`max-w-[85%] rounded-2xl px-4 py-3 ${message.sender === "team" ? "ml-auto bg-[#FF2D2D] text-[#0D0D0D]" : "bg-white/8"}`}>
                  ...
                  {readOnly ? (
                    ...
                    <form onSubmit={send} className="flex gap-2 border-t border-white/10 pt-4">
                      ...
                      <button className="rounded-full bg-[#FF2D2D] px-5 text-[#0D0D0D]">Send</button>
                    </form>
                  )}
                </div>

                <aside className="rounded-2xl border border-white/10 bg-black/30 p-4">
                  <p className="text-xs uppercase tracking-[.22em] text-[#FF2D2D]">Final quote</p>
                  ...
                  <button
                    ...
                    className="mt-4 w-full rounded-full bg-[#FF2D2D] px-5 py-3 font-semibold text-[#0D0D0D] disabled:cursor-not-allowed disabled:opacity-40"
                  >
