  ...
  if (services.length === 0) {
    return (
      <div className={`rounded-[1.8rem] border border-dashed px-7 py-10 text-center ${
        ...
        <p className="text-lg font-black">The service menu is being updated.</p>
        <p className={`mx-auto mt-2 max-w-lg text-sm leading-6 ${isLight ? "text-neutral-600" : "text-neutral-400"}`}>
          Send your vehicle details and what you want done. Car Dash Detailing will get back to you with pricing.
        </p>
        <a href="/contact" className="mt-6 inline-flex rounded-full bg-red-600 px-6 py-3 text-sm font-black text-white transition hover:bg-red-500">
          Get a Quote
        </a>
      </div>
    );
