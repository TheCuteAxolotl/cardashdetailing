    ...
    <>
      <div className="bg-red-600 text-white">
        <div className="mx-auto flex max-w-[1540px] items-center justify-between border-x border-white/15 px-5 py-2.5 text-[10px] font-semibold uppercase tracking-[.24em] sm:px-8 lg:px-10">
          ...
          <a
            href="/contact"
            className="hidden text-white/78 transition hover:text-white sm:block"
          >
            Request a detail ↗
          </a>
        </div>
      ...
      <header className="sticky top-0 z-50 border-b border-white/10 bg-[#070707]/94 text-white backdrop-blur-xl">
        <div className="mx-auto flex max-w-[1540px] items-center justify-between gap-5 border-x border-white/10 px-5 py-4 sm:px-8 lg:px-10">
          ...
          >
            <span className="grid h-10 w-10 place-items-center rounded-full border border-red-500/35 bg-red-600 text-[11px] font-black tracking-[-.06em]">
              CD
            </span>
            ...
            <div className="leading-none">
              ...
              <span className="mt-1 block text-[9px] uppercase tracking-[.3em] text-white/30">
                Detailing
              </span>
            </div>
          </a>
          ...
          <div className="hidden items-center gap-2 xl:flex">
            {!user ? (
              <a
                href="/login"
                className="rounded-full border border-white/15 px-4 py-2.5 text-xs font-semibold text-white/65 transition hover:border-white/35 hover:text-white"
              >
                Login
              </a>
            ) : (
              <button
                onClick={logout}
                className="px-3 text-xs font-semibold text-white/35 transition hover:text-white"
              >
                Logout
              </button>
            )}
            ...
            <a
              href="/contact"
              className="rounded-full bg-red-600 px-5 py-2.5 text-xs font-semibold text-white transition hover:bg-red-500"
            >
              Book Now
            </a>
          </div>
          ...
          <button
            ...
            className="rounded-full border border-white/15 px-4 py-2 text-xs font-semibold xl:hidden"
          >
            {menuOpen ? "Close" : "Menu"}
          </button>
        </div>
        ...
        {menuOpen && (
          <div className="border-t border-white/10 bg-[#080808] px-5 py-4 sm:px-8 xl:hidden">
            <nav className="flex flex-col text-sm text-white/60">
              ...
              <a
                href="/contact"
                className="mt-2 rounded-full bg-red-600 px-5 py-3 text-center font-semibold text-white"
              >
                Book Now
              </a>
            </nav>
