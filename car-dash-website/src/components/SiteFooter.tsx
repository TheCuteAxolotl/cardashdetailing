        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-6 py-14 md:grid-cols-[1.2fr_.8fr_.8fr]">
          <div>
            ...
            <p className="mt-5 max-w-md text-sm leading-7 text-neutral-400">
              Mobile detailing based in South Elgin. You pick the service, I come to you, and I take care of the detail.
            </p>
            <Link href="/contact" className="mt-6 inline-flex rounded-full bg-red-600 px-6 py-3 text-sm font-black transition hover:bg-red-500">
              Book Your Detail
            </Link>
          </div>
