  ...
  return (
    <footer className="border-t border-white/10 bg-[#0D0D0D] text-white">
      <div className="mx-auto grid max-w-[1540px] gap-12 border-x border-white/10 px-5 py-14 sm:px-8 lg:grid-cols-[1.15fr_.85fr] lg:px-10">
        <div>
          <div className="flex items-center gap-3"><span className="h-2 w-2 rounded-full bg-[#00F2FE] shadow-[0_0_14px_rgba(0,242,254,.55)]" /><p className="text-3xl font-semibold tracking-[-.045em]">Car Dash Detailing</p></div>
        ...
        <div className="grid grid-cols-2 gap-8 text-sm sm:grid-cols-3">
          <div>
            ...
            <div className="space-y-2 text-white/65"><a href="/about" className="block hover:text-[#00F2FE]">About Car Dash</a><a href="/ceramic-coatings" className="block hover:text-[#00F2FE]">Ceramic Coatings</a><a href="/products-we-use" className="block hover:text-[#00F2FE]">Products We Use</a><a href="/gallery" className="block hover:text-[#00F2FE]">Gallery</a></div>
          </div>
          <div>
            <p className="mb-3 text-[10px] font-semibold uppercase tracking-[.23em] text-white/28">Services + Help</p>
            <div className="space-y-2 text-white/65"><a href="/services" className="block hover:text-[#00F2FE]">Services</a><a href="/services#marine-add-ons" className="block hover:text-[#00F2FE]">Marine Add-Ons</a><a href="/faq" className="block hover:text-[#00F2FE]">FAQ</a><a href="/reviews" className="block hover:text-[#00F2FE]">Reviews</a><a href="/contact" className="block hover:text-[#00F2FE]">Book</a></div>
          </div>
          <div className="col-span-2 sm:col-span-1">
            <p className="mb-3 text-[10px] font-semibold uppercase tracking-[.23em] text-white/28">Contact + Legal</p>
            <div className="space-y-2 text-white/65"><a href="mailto:cardashdetailing@gmail.com" className="block break-all hover:text-[#00F2FE]">cardashdetailing@gmail.com</a><a href="/privacy-policy" className="block hover:text-[#00F2FE]">Privacy Policy</a><a href="/terms-and-conditions" className="block hover:text-[#00F2FE]">Terms and Conditions</a></div>
          </div>
        </div>
      </div>
