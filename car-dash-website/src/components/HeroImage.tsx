...
export default function HeroImage() {
  ...
  return (
    <div className="relative">
      <div className="absolute -inset-5 -z-10 rounded-[3rem] bg-[#00F2FE]/10 blur-3xl" />
        ...
        {image ? (
          <div className="relative">
            ...
            <div className="absolute inset-x-0 bottom-0 p-6 sm:p-7">
              <p className="text-[10px] font-black uppercase tracking-[0.28em] text-[#00F2FE]">Featured Work</p>
          ...
          <div className="relative flex h-[430px] items-end overflow-hidden p-7 sm:h-[510px]">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_25%,rgba(0,242,254,.20),transparent_38%),linear-gradient(145deg,#171717,#080808)]" />
            <div className="absolute inset-7 rounded-[1.4rem] border border-white/10" />
            <div className="relative">
              <p className="text-[10px] font-black uppercase tracking-[0.28em] text-[#00F2FE]">Homepage Hero</p>
