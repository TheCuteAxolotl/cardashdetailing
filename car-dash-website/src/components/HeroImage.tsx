...
export default function HeroImage() {
  ...
  return (
    <div className="relative">
      <div className="absolute -inset-5 -z-10 rounded-[3rem] bg-[#6EAEC6]/10 blur-3xl" />
      <div className="overflow-hidden rounded-[2rem] border border-white/10 bg-[#13232F] shadow-[0_30px_100px_rgba(0,0,0,.55)]">
        {image ? (
          <div className="relative">
          ...
          <div className="relative flex h-[430px] items-end overflow-hidden p-7 sm:h-[510px]">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_25%,rgba(110,174,198,.20),transparent_38%),linear-gradient(145deg,#171717,#080808)]" />
            <div className="absolute inset-7 rounded-[1.4rem] border border-white/10" />
            <div className="relative">
              <p className="text-[10px] font-black uppercase tracking-[0.28em] text-[#6EAEC6]">Homepage Hero</p>
