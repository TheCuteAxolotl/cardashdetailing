...
export default function HeroImage() {
  ...
  return (
    <div className="relative">
      <div className="absolute -inset-5 -z-10 rounded-[3rem] bg-[#FF2D2D]/10 blur-3xl" />
        ...
        {image ? (
          <div className="relative">
            ...
            <div className="absolute inset-x-0 bottom-0 p-6 sm:p-7">
              <p className="text-[10px] font-black uppercase tracking-[0.28em] text-[#FF2D2D]">Featured Work</p>
          ...
          <div className="relative flex h-[430px] items-end overflow-hidden p-7 sm:h-[510px]">
            ...
            <div className="relative">
              <p className="text-[10px] font-black uppercase tracking-[0.28em] text-[#FF2D2D]">Homepage Hero</p>
