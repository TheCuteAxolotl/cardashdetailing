    ...
    <div className="bg-[#080808] text-white">
          ...
          <div className="grid w-full gap-10 lg:grid-cols-[1.2fr_.8fr] lg:items-end">
            ...
            <div className="lg:pb-2">
              ...
              <div className="mt-7 flex flex-wrap gap-3">
                <Link href="/contact" className="rounded-full bg-red-600 px-6 py-3 text-sm font-semibold text-white transition hover:bg-red-500">
                  {content.heroPrimaryCta}
                </Link>
                <Link href="/services" className="rounded-full border border-white/18 bg-black/20 px-6 py-3 text-sm font-semibold text-white/80 backdrop-blur transition hover:border-white/35 hover:text-white">
      ...
      <section className="border-b border-white/10 bg-[#080808]">
        <div className="mx-auto max-w-[1480px] px-5 py-20 sm:px-8 sm:py-28 lg:px-12">
          ...
          <Link href="/services" className="mt-8 inline-flex text-sm font-semibold text-white/55 transition hover:text-red-400">View all services →</Link>
        </div>
      </section>
      ...
      <section className="border-b border-white/10 bg-[#0b0b0b]">
        <div className="mx-auto grid max-w-[1480px] gap-10 px-5 py-20 sm:px-8 sm:py-28 lg:grid-cols-2 lg:items-center lg:px-12">
          ...
          <div className="lg:pl-10">
            ...
            <Link href="/gallery" className="mt-8 inline-flex rounded-full border border-white/15 px-5 py-2.5 text-sm font-semibold text-white/70 transition hover:border-white/30 hover:text-white">See the work</Link>
          </div>
        </div>
      </section>
      ...
      <section className="border-b border-white/10 bg-[#080808]">
        <div className="mx-auto max-w-[1480px] px-5 py-20 sm:px-8 sm:py-28 lg:px-12">
          <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
            ...
            <Link href="/gallery" className="text-sm font-semibold text-white/48 transition hover:text-white">Full gallery →</Link>
          </div>
      ...
      <section className="bg-red-600 text-white">
        <div className="mx-auto flex max-w-[1480px] flex-col gap-8 px-5 py-16 sm:px-8 sm:py-20 lg:flex-row lg:items-end lg:justify-between lg:px-12">
          ...
          <div className="max-w-md">
            ...
            <Link href="/contact" className="mt-6 inline-flex rounded-full bg-black px-6 py-3 text-sm font-semibold text-white transition hover:bg-[#171717]">Book a detail</Link>
          </div>
        </div>
      </section>
    </div>
