  ...
  return (
    <main className="min-h-screen bg-[#050505] text-white">
      <div className="mx-auto max-w-6xl px-6 py-12">
        ...
        <p className="mt-2 text-sm text-white/45">Signed in as {user.email}. This account has access only to bookings and support.</p>

        <div className="mt-8 grid gap-5 sm:grid-cols-2">
          <a href="/admin/bookings" className="rounded-3xl border border-white/10 bg-white/[.025] p-8 transition hover:border-red-500/40">
          ...
          <a href="/admin/support" className="rounded-3xl border border-white/10 bg-white/[.025] p-8 transition hover:border-red-500/40">
            <p className="text-3xl">↗</p>
