...
export default function FAQPage() {
  ...
  return (
    <div className="min-h-screen bg-[#080808] text-white">
      <PublicHero imageCategory="faq-hero" eyebrowKey="faqEyebrow" titleKey="faqTitle" bodyKey="faqBody" action={<a href="/contact" className="inline-flex rounded-full bg-red-600 px-6 py-3.5 text-sm font-semibold hover:bg-red-500">Still need help?</a>} />
            ...
            <details key={index} className="group border-b border-white/8 last:border-b-0">
              <summary className="flex cursor-pointer items-center justify-between gap-6 px-6 py-6 sm:px-8 sm:py-7">
                <div className="flex items-start gap-4">
                  <span className="pt-1 text-[10px] font-semibold text-red-400">0{index + 1}</span>
