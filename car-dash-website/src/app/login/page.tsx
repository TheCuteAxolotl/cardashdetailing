    ...
    <div className="min-h-[72vh] bg-[#0B1822] px-6 py-16 text-white sm:py-24">
      <div className="mx-auto w-full max-w-md">
        <div className="rounded-[32px] border border-white/10 bg-[linear-gradient(145deg,rgba(74,85,104,.15),rgba(255,255,255,.02))] p-7 shadow-[0_28px_90px_rgba(0,0,0,.35)] sm:p-8">
          <p className="text-[10px] font-bold uppercase tracking-[.28em] text-[#6EAEC6]">Customer Account</p>
          ...
          <div className="mt-6 text-center text-sm text-white/42">
            Don&apos;t have an account? <a href={claimQuoteId ? `/register?claimQuoteId=${encodeURIComponent(claimQuoteId)}&email=${encodeURIComponent(email)}` : "/register"} className="font-semibold text-[#6EAEC6] hover:text-[#6EAEC6]">Create one</a>
          </div>
        </div>
      </div>
    </div>
