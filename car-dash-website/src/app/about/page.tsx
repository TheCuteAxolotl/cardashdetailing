...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0D0D0D] text-white">
      <PublicHero imageCategory="about-hero" eyebrowKey="aboutEyebrow" titleKey="aboutTitle" bodyKey="aboutIntro" action={<a href="/contact" className="inline-flex rounded-full bg-[#00F2FE] px-6 py-3.5 text-sm font-semibold text-[#0D0D0D] hover:bg-[#00F2FE]">Book a detail</a>} />
      ...
      <section className="bg-[#FFFFFF] text-black">
        <div className="mx-auto grid max-w-[1540px] border-x border-black/10 lg:grid-cols-[1.05fr_.95fr]">
          ...
          <div className="flex flex-col justify-center border-t border-black/10 px-5 py-16 sm:px-8 lg:border-l lg:border-t-0 lg:px-12 lg:py-24">
            <p className="text-[10px] font-semibold uppercase tracking-[.28em] text-[#00F2FE]">About</p>
      ...
      <section className="relative isolate overflow-hidden border-t border-white/10">
        ...
        <div className="mx-auto max-w-[1540px] border-x border-white/10 px-5 py-20 sm:px-8 lg:px-10">
          <p className="text-[10px] uppercase tracking-[.28em] text-[#00F2FE]">The basics</p>
          ...
          <div className="mt-12 grid gap-px overflow-hidden rounded-[28px] border border-white/10 bg-white/10 md:grid-cols-3">
            {[
              ...
              <article key={title} className="bg-[#111318] p-7 sm:p-8">
                <p className="text-xs font-semibold text-[#00F2FE]">0{index + 1}</p>
      ...
      <section className="bg-white text-[#0D0D0D]">
        <div className="mx-auto grid max-w-[1540px] gap-4 border-x border-black/10 px-5 py-16 sm:px-8 md:grid-cols-2 lg:px-10">
          <a href="/ceramic-coatings" className="group rounded-[28px] border border-black/10 bg-[#F7F9FA] p-7 hover:border-[#00F2FE]/60">
            ...
            <span className="mt-6 inline-flex text-sm font-semibold text-[#007D85]">Explore coatings →</span>
          </a>
          <a href="/products-we-use" className="group rounded-[28px] border border-black/10 bg-[#F7F9FA] p-7 hover:border-[#00F2FE]/60">
            ...
            <span className="mt-6 inline-flex text-sm font-semibold text-[#007D85]">See the product approach →</span>
          </a>
        </div>
      </section>
    </div>
