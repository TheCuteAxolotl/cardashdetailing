    ...
    <div className="min-h-screen bg-white text-slate-950">
      <main className="mx-auto max-w-7xl px-6 py-12">
        <div className="max-w-4xl">
          <p className="mb-4 inline-flex rounded-full border border-slate-200 bg-slate-50 px-4 py-2 text-xs font-semibold uppercase tracking-[0.35em] text-slate-500">
        ...
        <section className="mt-14 grid gap-6 xl:grid-cols-3">
          {servicePackages.map((pkg) => (
            <article key={pkg.name} className="rounded-[2rem] border border-slate-200 bg-slate-50 p-8 shadow-sm shadow-slate-100">
              <div className="mb-6 flex items-center justify-between gap-4">
                <div>
                  <p className="text-sm font-semibold uppercase tracking-[0.32em] text-slate-500">{pkg.name}</p>
        ...
        <section className="mt-16 rounded-[2rem] border border-slate-200 bg-slate-50 px-8 py-10">
          <div className="grid gap-8 xl:grid-cols-[1.2fr_0.9fr] xl:items-center">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.35em] text-slate-500">Add-on services</p>
            ...
            <div className="rounded-[1.75rem] border border-slate-200 bg-white p-6">
              <p className="text-sm font-semibold uppercase tracking-[0.25em] text-slate-500">Important pricing notes</p>
