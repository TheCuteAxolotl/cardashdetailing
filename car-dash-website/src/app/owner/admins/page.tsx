    ...
    <main className="min-h-screen bg-[#080808] text-white">
      <div className="mx-auto max-w-6xl px-5 py-10 sm:px-8">
        <div className="flex flex-wrap items-end justify-between gap-4 border-b border-white/10 pb-6">
          <div>
            <p className="text-[10px] font-semibold uppercase tracking-[.28em] text-[#FF2D2D]">Owner only</p>
        ...
        <div className="grid gap-6 py-8 lg:grid-cols-[1fr_1.1fr]">
          <section className="rounded-[24px] border border-white/10 bg-white/[.025] p-6">
            ...
            <form onSubmit={createAdmin} className="mt-5 space-y-4">
              ...
              <button disabled={saving} className="w-full rounded-full bg-[#FF2D2D] px-5 py-3 text-sm font-semibold text-[#0D0D0D] hover:bg-[#FF2D2D] disabled:opacity-50">
