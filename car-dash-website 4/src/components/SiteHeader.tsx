    ...
    <header className="sticky top-0 z-50 border-b border-white/10 bg-black/90 text-white backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-5 px-6 py-4">
        <Link href="/" className="flex items-center gap-3">
          <span className="grid h-8 w-8 place-items-center rounded-full border border-red-500/30 bg-red-500/10 text-sm font-black text-red-500">C</span>
          <span className="text-sm font-black uppercase tracking-[0.24em]">Car Dash</span>
        </Link>
      ...
      {menuOpen && (
        <div className="border-t border-white/10 bg-black px-6 pb-6 md:hidden">
