...
export default function ReviewCards() {
  ...
  if (!reviews.length) return <div className="rounded-[2rem] border border-white/10 bg-white/[0.035] p-8 text-neutral-400">Approved customer reviews will show here.</div>;
